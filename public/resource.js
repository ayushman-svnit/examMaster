let mathBooks = [
  {
    ...
    path: "http://localhost:3000/jee-a-pyq-m.pdf",
  },
  {
    name: "Mathematics Formula Handbook",
    path: "http://localhost:3000/handbook-m.pdf",
  },
];
let phyBooks = [
  {
    name: "DC Pandey - Volume 1",
    path: "http://localhost:3000/dcpandeyvol1.pdf",
  },
  {
    name: "DC Pandey - Volume 2",
    path: "http://localhost:3000/dcpandeyvol2.pdf",
  },
  {
    name: "DC Pandey - Volume 3",
    path: "http://localhost:3000/dcpandeyvol3.pdf",
  },
  {
    name: "DC Pandey - Volume 4",
    path: "http://localhost:3000/dcpandeyvol4.pdf",
  },
  {
    name: "DC Pandey - Volume 5",
    path: "http://localhost:3000/dcpandeyvol5.pdf",
  },
  {
    name: "Physics Formula Handbook",
    path: "http://localhost:3000/handbook-p.pdf",
  },
  {
    name: "Physics JEE Advanced PYQ",
    path: "http://localhost:3000/jee-a-pyq-p.pdf",
  },
];
let chemBooks = [
  {
    name: "Chemistry JEE Advanced PYQ",
    path: "http://localhost:3000/jee-a-pyq-c.pdf",
  },
  {
    name: "Chemistry Handbook",
    path: "http://localhost:3000/handbook-c.pdf",
  },
  {
    name: "Himanshu Pandey - Organic Chemistry",
    path: "http://localhost:3000/hpandeyoc.pdf",
  },
  {
    name: "N Awasthi - Physical Chemistry",
    path: "http://localhost:3000/n-awasthi.pdf",
  },
  {
    name: "Vishal Joshi - Inorganic Chemistry",
    path: "http://localhost:3000/vj-ioc.pdf",
  },
  {
    name: "VK Jaiswal - Inorganic Chemistry - 1 to 5",
    path: "http://localhost:3000/vkj1to5.pdf",
  },
  {
    name: "VK Jaiswal - Inorganic Chemistry - 6 to 11",
    path: "http://localhost:3000/vkj6to11.pdf",
  },
];
...
let mathNotes = [
  {
    ...
    path: "http://localhost:3000/AOD.pdf",
  },
  {
    name: "Indefinite Integration",
    path: "http://localhost:3000/indefinite-integration.pdf",
  },
  {
    name: "Inverse Trigonometric Functions",
    path: "http://localhost:3000/itf.pdf",
  },
  {
    name: "Methods of Differentiation",
    path: "http://localhost:3000/mod.pdf",
  },
  {
    name: "Matrices and Determinants",
    path: "http://localhost:3000/mnd.pdf",
  },
];
// let phyNotes=[
//     {
...
let chemNotes = [
  {
    ...
    path: "http://localhost:3000/coordinationcompounds-1.pdf",
  },
  {
    name: "Name Reactions",
    path: "http://localhost:3000/nmrxn.pdf",
  },
  {
    name: "P Block Elements - Group 13 to 14",
    path: "http://localhost:3000/p-block-13to14.pdf",
  },
  {
    name: "S Block Elements",
    path: "http://localhost:3000/s-block.pdf",
  },
];
